...
BACKEND_REST_URL=http://localhost:3001
NEXT_PUBLIC_BACKEND_GRAPHQL_URL=http://localhost:3001/graphql
NEXT_PUBLIC_BACKEND_REST_URL=http://localhost:3001
...
Ensure your backend GraphQL server is running on `http://localhost:3001/graphql` with the following features:
